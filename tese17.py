...
# แล้วคำนวณราคาสินค้าที่รับส่วนลดแล้วทางหน้าจอ โดยสินค้าประเภท food ลด 2% ของราคาสินค้า, woman ลด 4%
# ของราคาสินค้า, man ลด 6% ของราคาสินค้า, kitchen ลด 10% ของราคาสินค้า
...
if pro_type == 'F' or pro_type == 'f':
    pro_sale = product_price - (product_price * 2 / 100)
    print(f'ราคาสินค้าที่ลดแล้วเป็น {pro_sale} บาท')
elif pro_type == 'W' or pro_type == 'w':
    pro_sale = product_price - (product_price * 4 / 100)
    print(f'ราคาสินค้าที่ลดแล้วเป็น {pro_sale} บาท')
elif pro_type == 'M' or pro_type == 'm':
    pro_sale = product_price - (product_price * 6 / 100)
    print(f'ราคาสินค้าที่ลดแล้วเป็น {pro_sale} บาท')
elif pro_type == 'K' or pro_type == 'k':
    pro_sale = product_price - (product_price * 10 / 100)
    print(f'ราคาสินค้าที่ลดแล้วเป็น {pro_sale} บาท')
else:
    print(f'คุณป้อนประเภทผิด !!! ป้อนใหม่โด้ย')  
print('-------------------------')